...
export function loadHomeData() {
    firebase.database().ref('/totechcareerfairDBMI/homescreen').on('value', (snapshot) => {
...
export function loadScheduleData() {
  firebase.database().ref('/totechcareerfairDBMI/schedulescreen').on('value', (snapshot) => {
    var tempJSON = snapshot.val();
...
export function loadExhibitorData() {
  firebase.database().ref('/totechcareerfairDBMI/exhibitorscreen').on('value', (snapshot) => {
    var tempJSON = snapshot.val();
...
export function loadSpeakerData() {
  firebase.database().ref('/totechcareerfairDBMI/speakerscreen').on('value', (snapshot) => {
    var tempJSON = snapshot.val();
...
export function loadTicketData() {
  firebase.database().ref('/totechcareerfairDBMI/ticketscreen').on('value', (snapshot) => {
    var tempJSON = snapshot.val();
